...
{
    "newOrder": {
        "orderId": "86be21b6-f2ab-4bce-9b7e-a8d16ee5744b",
        "eta": 15,
        "total": 49,
        "userId": "user_123",
        "createdAt": "2026-04-07T09:39:31.790Z"
    },
    "message": "Order mottagen! Din beställning kommer att vara klar om ca 15 minuter."
}
```
...
```json
{
    "message": "Din beställning är framme!"
}

Eller:

{
    "message": "Din beställning är på väg! Beräknad tid kvar: 9 minuter"
} 
```
---
